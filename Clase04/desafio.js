...
class ProductManager {
    ...
    getProductByID(id){
        ...
        if (idProducto === undefined){
            ...
            console.log ("Producto encontrado " + id, idProducto)
        }
        return idProducto 
    }
    ...
    addProduct(p){
        ...
        this.products.forEach(product => {if(product.id > idDelNuevoProducto)idDelNuevoProducto=product.id})
        idDelNuevoProducto++
...
administradorDeProductosNuevo.updateProduct(006, producto6)
